...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                MessageBox.Show("Data mahasiswa berhasil di delete !",
               "Informasi", MessageBoxButtons.OK,
                ...
                MessageBox.Show("Data mahasiswa gagal delete !!!",
               "Informasi", MessageBoxButtons.OK,
                MessageBoxIcon.Exclamation);
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\pemograman\Rezha_22.11.4750\pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
                // deklarasi variabel connectionString, ref:https://www.connectionstrings.com/
                string connectionString = string.Format("Data Source ={0}; FailIfMissing = True", dbName);

                conn = new SQLiteConnection(connectionString); // buat objek conect 
        ...
        private void txtNamaDelete_TextChanged(object sender, EventArgs e)
        {
